...
# Đọc dữ liệu 627 users
df = pd.read_csv('../marketing_campaign_627_users.csv', sep='\t')
...
results_df.to_csv('model_results_627_users.csv', index=False)
...
import joblib
joblib.dump(scaler, 'optimized_scaler_627.pkl')
joblib.dump(best_model, 'optimized_model_627.pkl')

print("\nĐã lưu mô hình và scaler mới!")
print("Files được lưu:")
print("- optimized_scaler_627.pkl")
print("- optimized_model_627.pkl")
print("- model_results_627_users.csv")

# Hiển thị feature importance nếu là tree-based model
if hasattr(best_model, 'feature_importances_'):
    ...
    feature_importance.to_csv('feature_importance_627.csv', index=False)
    print("\nĐã lưu feature importance vào: feature_importance_627.csv")